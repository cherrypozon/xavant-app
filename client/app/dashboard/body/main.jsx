...
const Body = () => {
    ...
    const zones = [
        { label: "Indoor Pool", percent: 20 },
        { label: "Outdoor Pool", percent: 35 },
        { label: "Lobby", percent: 11 },
        { label: "North Entrance", percent: 10 },
        { label: "Hall Way", percent: 6 },
        { label: "Elevator", percent: 11 },
        { label: "Stairway", percent: 7 },
    ];
    ...
    const activeAlerts = [
        {
            title: 'Unattended Item at North Hallway B',
            item: 'Bag',
            time: '9:15',
            status: 'Not assigned',
        },
        {
            title: 'Towels and Garbage at North Hallway B',
            item: 'Towels',
            category: 'Urgent',
            status: 'Assigned',
        },
        {
            title: 'Wetfloor at Indoor Pool area',
            item: 'Wetfloor',
            category: 'Non-urgent',
            status: 'Assigned',
        },
        ...
        <div>
            ...
            <div className="flex justify-between items-start gap-5">
                <div className='p-5 h-40 w-1/3 bg-[linear-gradient(0deg,#85A3FF1A,#DCE1F21A)] rounded-[10px]'>
                    <div className='flex items-center gap-2'>
                        ...
                        <h1 className='flex flex-col font-semibold text-[17px] text-[#8BA7FF]'>Security Overview <span className='text-[10px] opacity-80 font-normal text-white'>Real-time security monitoring</span></h1>
                    </div>
                    <div className='ml-[37px] mt-3 flex items-center justify-items-center gap-2.5'>
                    ...
                    <div className='flex items-center justify-items-center mt-3 ml-[37px] gap-6'>
                        <h1 className='font-semibold text-[19px] text-white flex justify-items-center items-center gap-2'>8<span className='text-[10px] opacity-80 font-normal text-white'>Cameras Online</span></h1>
                        <h1 className='font-semibold text-[19px] text-white flex justify-items-center items-center gap-2'>12<span className='text-[10px] opacity-80 font-normal text-white'>Zones Secured</span></h1>
                    </div>
                </div>
                <div className='p-5 h-53 w-1/3 bg-[linear-gradient(0deg,#85A3FF1A,#DCE1F21A)] rounded-[10px]'>
                    <div className='flex items-center gap-2'>
                        ...
                        <h1 className='flex flex-col font-semibold text-[17px] text-[#DE27EFB3]'>Event Timeline <span className='text-[10px] opacity-80 font-normal text-white'>Last 24 hours activity</span></h1>
                    </div>
                    <div className='relative ml-[37px] mt-3'>
                        ...
                        {events.map((event, index) => (
                            <div key={index} className='relative mb-2 flex items-center ml-6'>
                                <div className='absolute left-[-19px] top-1 w-2 h-2 bg-[#DE27EF] rounded-full opacity-70'></div>
                                <h2 className='text-[10px] font-normal opacity-90 mb-1'>{event.time} <span>{event.text}</span></h2>
                            </div>
                        ))}
                    </div>
                    <div className='font-medium mb-3 text-xs text-[#DE27EF] opacity-70 hover:opacity-100 cursor-pointer'>View all events →</div>
                </div>
                <div className='p-5 h-40 w-1/3 bg-[linear-gradient(0deg,#85A3FF1A,#DCE1F21A)] rounded-[10px]'>
                    <div className='flex items-center gap-2'>
                        <img src="heart.svg" alt="heart" className='w-[35px] h-[35px]' />
                        <h1 className='flex flex-col font-semibold text-[17px] text-[#14AE5C]'>System Health <span className='text-[10px] opacity-80 font-normal text-white'>Performance & alerts</span></h1>
                    </div>
                    <div className='ml-[37px] mt-3 flex items-center justify-items-center gap-2.5'>
                        <div className='flex flex-col gap-2'>
                            <div className='flex items-center gap-15 ml-1.5'>
                                <img src="videoIcon.svg" alt="video Icon" />
                                <h2 className='font-semibold text-[10px] text-[#FFFFFFB3]'>Camera</h2>
                                <img src="checkIcon.svg" alt="check Icon" />
                            </div>
                            <div className='flex items-center gap-15 ml-1.5'>
                                <img src="storageIcon.svg" alt="video Icon" />
                                <h2 className='font-semibold text-[10px] text-[#FFFFFFB3]'>Storage</h2>
                                <h2 className='font-semibold text-[10px] text-[#FFFFFFB3]'>75% Used</h2>
                            </div>
                            <div className='flex items-center gap-15 ml-1.5'>
                                <img src="wifiIcon.svg" alt="video Icon" />
                                <h2 className='font-semibold text-[10px] text-[#FFFFFFB3]'>Network</h2>
                                <img src="checkIcon.svg" alt="check Icon" className='ml-[-3px]' />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='w-full mt-3 flex gap-5'>
                <div className='w-[65%]'>
                    ...
                    <div className=' flex gap-4 bg-[linear-gradient(0deg,#85A3FF1A,#DCE1F21A)] rounded-[10px] p-5'>
                        <div className='w-1/2 flex justify-between items-center p-5 bg-[linear-gradient(0deg,#85A3FF4D,#DCE1F24D)] rounded-[10px]'>
                            <div className='flex flex-col gap-5 w-full'>
                                <div className='flex items-center gap-2'>
                                    ...
                                    <h1 className='flex flex-col font-semibold text-[17px]'>Hourly Motion <span className='text-[10px] opacity-80 font-normal -mt-1'>Detection Count</span></h1>
                                </div>
                                <LineGraph
                        ...
                        <div className='w-1/2 flex flex-col gap-3 bg-[linear-gradient(0deg,#85A3FF4D,#DCE1F24D)] rounded-[10px] p-5'>
                            <div className='flex items-center gap-2'>
                                ...
                                <h1 className='flex flex-col font-semibold text-[17px]'>Peak Foot - Traffic Zones <span className='text-[10px] opacity-80 font-normal -mt-1'>Number of People in the Area</span></h1>
                            </div>
                            ...
                            <div className='grid grid-cols-2 grid-rows-2 gap-2'>
                                <div className='bg-[#56658c] px-4 py-2 rounded-[10px] flex flex-col gap-1'>
                                    ...
                                    <p className='font-normal text-[9px] flex justify-between'>Outdoor Pool <span className='text-[#14AE5C] font-bold text-[8px]'>35 % Traffic</span></p>
                                </div>
                                <div className='bg-[#56658c] px-4 py-2 rounded-[10px] flex flex-col gap-1'>
                                    <div className=' flex items-center gap-1'>
                                    ...
                                    <p className='font-normal text-[9px] flex justify-between'>Hallway<span className='text-[#14AE5C] font-bold text-[8px]'>6 % Traffic</span></p>
                                </div>
                                <div className='col-span-2 row-start-2 bg-[#56658c] px-4 py-2 rounded-[10px] flex flex-col gap-1'>
                                    ...
                                    <p className='font-normal text-[9px] flex justify-between'>2 Zones above average<span className='text-[#14AE5C] font-bold text-[8px]'>Indoor Pool, Outdoor Pool</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className=''>
                        <p className='font-medium text-[16px] my-3'>Area Activity Report</p>
                        <div className='bg-[linear-gradient(0deg,#85A3FF1A,#DCE1F21A)] rounded-[10px] p-5'>
                            <div className='flex justify-between items-center mb-2'>
                                <div className='flex items-center gap-2'>
                                    <img src="mapPin.svg" alt="pin" />
                                    <h1 className='flex flex-col font-semibold text-[17px]'>Area Activity Report <span className='text-[10px] opacity-80 font-normal -mt-1'>7-day comparison & analytics</span></h1>
                                </div>
                                <div className='bg-[#4B5672] py-1 px-3 rounded-[10px] font-medium text-[12px] cursor-pointer'>Refresh All Data</div>
                            </div>
                            {/* Table Component */}
                            <AreaActivityReport data={data} />
                        </div>
                    </div>
                </div>
                {/* Active Alert Card */}
                <div className='w-[35%] flex flex-col gap-4'>
                    ...
                    <div className='w-full max-h-[500px] bg-[linear-gradient(0deg,#85A3FF1A,#DCE1F21A)] rounded-[10px] p-4 grid grid-cols-2 grid-rows-2 gap-3'>
                        <div className='h-[188px] rounded-[10px] relative'>
                            <img src="sample1.png" alt="sample1" className='h-full w-full' />
                            <div className='absolute top-3 flex justify-between items-center w-full px-2'>
                                <p className='font-medium text-[10px]'>North Entrance</p>
                                <div className='rounded-[10px] px-2 py-1 bg-[#00FF40A6] font-semibold text-[8px]'>Online</div>
                            </div>
                        </div>
                        <div className='h-[188px] rounded-[11px] relative'>
                            <img src="sample2.png" alt="sample2" className='h-full w-full' />
                            <div className='absolute top-3 flex justify-between items-center w-full px-2'>
                                <p className='font-medium text-[10px]'>Main Reception</p>
                                <div className='rounded-[10px] px-2 py-1 bg-[#00FF40A6] font-semibold text-[8px]'>Online</div>
                            </div>
                        </div>
                        <div className='h-[188px] rounded-[10px] relative'>
                            <img src="sample3.png" alt="sample3" className='h-full w-full' />
                            <div className='absolute top-3 flex justify-between items-center w-full px-2'>
                                <p className='font-medium text-[10px]'>Hallway</p>
                                <div className='rounded-[10px] px-2 py-1 bg-[#00FF40A6] font-semibold text-[8px]'>Online</div>
                            </div>
                        </div>
                        <div className='h-[188px] rounded-[10px] relative'>
                            <img src="sample4.png" alt="sample4" className='h-full w-full' />
                            <div className='absolute top-3 flex justify-between items-center w-full px-2'>
                                <p className='font-medium text-[10px]'>Indoor Pool</p>
                                <div className='rounded-[10px] px-2 py-1 bg-[#FF3737] font-semibold text-[8px]'>Offline</div>
                            </div>
                        </div>
                    </div>
                </div>
